...
public class BiomeHelper
{
    ...
    public static final float BASE_TEMP = 3.0f; //temperature of the biome. Far hotter than a desert
    public static final float BASE_DOWNFALL = 0.0f; //I do not know what downfall is... rainfall amount maybe?
